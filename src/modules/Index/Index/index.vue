<template>
  <div class="box">
    <el-row>
      <el-col class="group" :xs="8" :sm="8" :md="6" :lg="6" :xl="6">
      ...
      <el-col class="group" :xs="8" :sm="8" :md="6" :lg="6" :xl="6">
        ...
        <router-link to="/FriendShip">关注列表</router-link>
      </el-col>
    </el-row>
    <!-- 广告 -->
    <div class="guanggao" v-if="isGuanggao">
      ...
      <el-button class="close" type="danger" icon="el-icon-circle-close" @click="onCloseGuanggao()">关闭</el-button>
    </div>
  </div>
</template>
